          ...
          <div className="print-section" style={{ marginTop: '40px' }}>
            ...
            <div style={{ padding: '16px', fontSize: '12px', lineHeight: '2', color: '#374151' }}>
              <ul style={{ margin: '0', paddingLeft: '20px', listStyleType: 'disc' }}>
                <li style={{ marginBottom: '8px' }}>Fields marked with ★ <strong>NEW</strong> are newly added this year. Please pay special attention to these.</li>
                <li style={{ marginBottom: '8px' }}>A signed hard copy of this report must be kept at the National Office.</li>
                <li style={{ marginBottom: '8px' }}>A signed copy of this form must also be sent to Additional Wakālat Tabshīr in addition to the online form.</li>
                <li style={{ marginBottom: '8px' }}>Any other additional information that you wish to submit with your report should also be sent to Wakālat Tabshīr on <strong>jalsauk@tabshir.org</strong></li>
              </ul>
